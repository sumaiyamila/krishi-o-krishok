...
public class SignIn extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(getApplicationContext(),"Signin e dhuksi",Toast.LENGTH_LONG).show();
    ...
    public void onClick(View view) {
        ...
        if (view == textViewSignup){
            startActivity(new Intent(SignIn.this, SelectStatus.class));
            finish();
        }
    ...
    private void userLogin() {
        ...
        if (TextUtils.isEmpty(email)){
            Toast.makeText(this, "মেইল দিন!", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SignIn.this, "মেইল অথবা পাসওয়ার্ড ভুল!! ", Toast.LENGTH_SHORT).show();
                            progressDialog.hide();
                        }
                    }
                });
